...
<div class="form-three widget-shadow">
    <div class="panel panel-primary">
      <div class="panel-heading ">
          <h3 style="font-size: 18px;" class="panel-title "> Admin Customer </h3>
        <!--============================================search============================================--> 
        ...
        <!--==========================================end search==========================================-->
          <a  href="{{ route('adminNewCustomer') }}" class="btn btn-success" style="margin-left: 74%; margin-top: -10px;" > New Customer</a>
      </div>  
    </div>
      ...
      <table class="table table-striped" id="myTable">
        ...
        <tbody>
          ...
          <tr>  
            ...
            <td>{{ $customer->job }} </td>
            <td>
            <a href="{{ route('adminEditCustomer', $customer->id) }}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
            <form style="display: none;" id="deleteCustomer-{{ $customer->id }}" action="{{route('adminDeleteCustomer', $customer->id )}}" method="POST">@csrf</form>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <form  id="deleteCustomer-{{ $customer->id }}" action="{{route('adminDeleteCustomer', $customer->id )}}" method="POST">@csrf
