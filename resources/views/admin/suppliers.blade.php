...
@section('title') Admin Suppliers @endsection

@section('content')
<div class="form-three widget-shadow">
  <div class="panel panel-primary">
    <div class="panel-heading ">
        <h3 style="font-size: 18px;" class="panel-title "> Admin Suppliers </h3>
          <!--============================================search============================================--> 
          ...
          <!--==========================================end search==========================================-->
        <a  href="{{ route('adminNewSupplier') }}" class="btn btn-success" style="margin-left: 74%; margin-top: -10px;" > New Supplier</a>
    </div>  
  </div>
    ...
    <table class="table table-striped" id="myTable">
      ...
      <tbody>
        ...
        <tr>  
          ...
          <td>
          <a href="{{ route('adminEditSupplier', $supplier->id) }}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
          <form style="display: none;" id="deleteSupplier-{{ $supplier->id }}" action="{{route('adminDeleteSupplier', $supplier->id )}}" method="POST">@csrf</form>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form  id="deleteSupplier-{{ $supplier->id }}" action="{{route('adminDeleteSupplier', $supplier->id )}}" method="POST">@csrf
