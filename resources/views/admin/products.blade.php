...
<div class="form-three widget-shadow">
  <div class="panel panel-primary">
    <div class="panel-heading ">
        <h3 style="font-size: 18px;" class="panel-title "> Admin Products </h3>

          <!--============================================search============================================--> 
          <div class="container" style="margin-top:8%;">

          <input id="search" type="text" placeholder="Search..." onkeyup="myFunction2()">
        ...
        <a  href="{{ route('adminNewProduct') }}" class="btn btn-success" style="margin-left: 88%; margin-top: -5%;" > New Product</a>
    </div>  
  </div>
    ...
    <table class="table table-striped" id="myTable">
      ...
      <tbody>
        ...
        <tr>  
          ...
          <td>
          <a href="{{ route('adminEditProduct', $product->id) }}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
          <form style="display: none;" id="deleteProduct-{{ $product->id }}" action="{{route('adminDeleteProduct', $product->id )}}" method="POST">@csrf</form>
